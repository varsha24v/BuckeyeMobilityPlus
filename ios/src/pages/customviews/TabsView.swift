                ...
                LazyHStack {
                    ForEach(0 ... tabs.count - 1, id: \.self) { index in
                        Text("\(tabs[index])")
                            ...
                            .foregroundColor(tabs[index] == selectedTab ? selectedFontColor : unSelectedFontColor)
                            .padding(12)
                            .background(tabs[index] == selectedTab ? selectedBackColor : unSelectedBackColor)
                ...
                LazyHStack(spacing: 0) {
                    ForEach(0 ... tabs.count - 1, id: \.self) { index in
                        VStack(spacing: 0) {
                            ...
                            Divider()
                                .frame(width: CGFloat(lineWidth), height: CGFloat(lineHeight), alignment: .center)
                                .background(tabs[index] == selectedTab ? selectedLineColor : Color.clear)
